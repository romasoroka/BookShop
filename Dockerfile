...
COPY ["WebSite.DataAccess/WebSite.DataAccess.csproj", "WebSite.DataAccess/"]
COPY ["WebSite.Models/WebSite.Models.csproj", "WebSite.Models/"]
COPY ["WebSite.Utility/WebSite.Utility.csproj", "WebSite.Utility/"]
